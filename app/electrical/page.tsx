...
export default function ElectricalPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-b from-yellow-50 to-white pt-16 pb-20 px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-yellow-100 text-yellow-700 text-xs font-semibold px-3 py-1.5 rounded-full mb-6 mt-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-10">
            From panel upgrades to emergency calls — AutoGrowth makes sure AI
            and Google recommend your electrical business first.
          </p>
          <a
            href="#waitlist"
            className="inline-flex items-center gap-2 bg-yellow-500 hover:bg-yellow-600 text-white font-semibold px-8 py-4 rounded-xl text-base transition-colors"
          >
